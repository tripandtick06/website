...
// CF Pages build: client-only fetch /api/b2b/auth/me; next-on-pages
// vercel build "lambda not found /de/b2b/dashboard" hatasi static-prerender
// sirasinda dusuyordu — bu workaround server-side wrapper page.server.tsx
// olarak refactor edilecek Q2'de. Su an client-only.
