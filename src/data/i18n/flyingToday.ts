...
const tr: FlyingTodayCopy = {
  ...
  ctaText: "Standart ve Deluxe balon uçuşlarında güncel fiyatı görün, hava iptalinde %100 iade güvencesiyle rezervasyon yapın.",
...
const en: FlyingTodayCopy = {
  ...
  ctaText: "See live prices for the Standard and Deluxe balloon flights and book with a 100% refund guarantee on weather cancellation.",
...
const de: FlyingTodayCopy = {
  ...
  ctaText: "Aktuelle Preise für Standard- und Deluxe-Ballonfahrten ansehen und mit 100 % Erstattung bei wetterbedingter Absage buchen.",
...
const fr: FlyingTodayCopy = {
  ...
  ctaText: "Consultez les prix en direct des vols Standard et Deluxe et réservez avec remboursement à 100 % en cas d'annulation météo.",
...
const ptBR: FlyingTodayCopy = {
  ...
  ctaText: "Veja os preços ao vivo dos voos Standard e Deluxe e reserve com garantia de reembolso de 100% em cancelamento por tempo.",
...
const ja: FlyingTodayCopy = {
  ...
  ctaTitle: "フライトを計画する",
  ctaText: "スタンダードとデラックスの気球フライトの最新料金を確認し、天候欠航時100%返金保証で予約。",
  ctaButton: "気球ツアーを見る",
...
const ko: FlyingTodayCopy = {
  ...
  ctaTitle: "비행 계획하기",
  ctaText: "스탠다드·디럭스 열기구 비행의 실시간 가격을 확인하고 날씨 취소 시 100% 환불 보장으로 예약하세요.",
  ctaButton: "열기구 투어 보기",
