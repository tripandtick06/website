...
export const SERVICE_DESCRIPTIONS: Record<string, LocalizedText> = {
  ...
  // ---------- ACTIVITIES — Balon + Flying Dress çekimi ----------
  "balon-flying-dress-cekimi": {
    tr: "Balon + Flying Dress fotoğraf çekimi, gün doğumunda balona binme deneyimini profesyonel bir çekimle tek üründe birleştirir. Standart sepette gün doğumu uçuşuna çıktıktan sonra fotoğrafçınız sepet içinde ve vadi manzarasının önünde 30 dakikalık özel bir çekim yapar; en iyi karelerden 20 tanesi düzenlenerek dijital olarak teslim edilir. Instagram ve TikTok için akışta öne çıkan içerikler isteyen misafirler, flying dress elbise kiralama seçeneğini ekleyerek uçuş görüntülerini akışkan elbise konseptiyle tamamlayabilir. Elbise kiralama opsiyoneldir ve teslim sonrasında anlaşmalı partner atölyelerde sağlanır; rezervasyon adımında not alanına beden ve renk tercihinizi yazmanız yeterlidir.",
    en: "The Balloon + Flying Dress photo shoot combines a sunrise balloon flight with a professional photoshoot in a single product. After your sunrise flight in a standard basket, your photographer takes a private 30-minute shoot inside the basket and against the valley backdrop; the 20 best frames are edited and delivered digitally. Guests chasing scroll-stopping content for Instagram and TikTok can add the optional flying dress rental to complete their flight shots with the flowing-dress concept. Dress rental is optional and provided via partner ateliers after booking — just write your size and colour preference in the note field during reservation.",
  },
  // ---------- TOURS ----------
  "kirmizi-tur": {
    tr: "Kapadokya Kırmızı Tur (Red Tour), bölgenin kuzeyindeki en ünlü durakları tek günde toplar: Zelve Açık Hava Müzesi, Uçhisar Kalesi, Paşabağ (Rahipler Vadisi), Avanos çömlek atölyesi, Devrent (Hayal Vadisi), Aşk Vadisi, deri mağazası, Göreme Panorama ve Güvercinlik Vadisi. Otelden alış ve bırakış transferi, profesyonel turist rehberi, öğle yemeği ve müze giriş biletleri fiyata dahildir. Kapadokya'ya ilk kez gelenler için en doğru başlangıç turudur; fiyatlar 50 €'dan başlar, tarihinize göre güncel fiyatı WhatsApp'tan öğrenin.",
    en: "The Cappadocia Red Tour gathers the region's most famous northern stops into a single day: Zelve Open-Air Museum, Uçhisar Castle, Paşabağ (Monks Valley), an Avanos pottery workshop, Devrent (Imagination Valley), Love Valley, a leather shop, Göreme Panorama and Pigeon Valley. Hotel pick-up and drop-off, a professional tourist guide, lunch and museum entrance tickets are all included. It is the ideal first tour for anyone new to Cappadocia; prices start from €50 — message us on WhatsApp for the current price on your date.",
  },
  "yesil-tur": {
    tr: "Kapadokya Yeşil Tur (Green Tour), Kırmızı Tur rotasının tamamına bir yeraltı şehri ekler: Yeraltı şehri, Zelve Açık Hava Müzesi, Uçhisar Kalesi, Paşabağ (Rahipler Vadisi), Avanos çömlek atölyesi, Devrent (Hayal Vadisi), Aşk Vadisi, deri mağazası, Göreme Panorama ve Güvercinlik Vadisi. Otelden alış ve bırakış transferi, profesyonel turist rehberi, öğle yemeği ve müze giriş biletleri dahildir. Yerin altını ve üstünü aynı günde görmek isteyenler için; fiyatlar 50 €'dan başlar, güncel fiyat için WhatsApp'tan yazın.",
    en: "The Cappadocia Green Tour adds an underground city to the full Red Tour route: an underground city, Zelve Open-Air Museum, Uçhisar Castle, Paşabağ (Monks Valley), an Avanos pottery workshop, Devrent (Imagination Valley), Love Valley, a leather shop, Göreme Panorama and Pigeon Valley. Hotel pick-up and drop-off, a professional tourist guide, lunch and museum entrance tickets are included. For those who want to see Cappadocia both above and below ground in one day; prices start from €50 — write to us on WhatsApp for the current price.",
  },
  "mix-tur": {
  ...
  "eco-yesil-tur": {
    tr: "Eco Green Tur, Kapadokya'nın güneyindeki doğa ve yeraltı rotasıdır: Göreme Panorama ve Güvercinlik Vadisi ile başlar, oniks atölyesine uğrar, Kaymaklı ve Derinkuyu yeraltı şehirlerine iner, Ihlara Vadisi'nde yürüyüş yapar, Nar Gölü'nde mola verir ve yöresel lezzetlerin tadımıyla biter. Profesyonel tur rehberi, transfer, öğle yemeği ve müze giriş biletleri dahildir; tur 09.30-18.00 arasındadır. Fiyatlar 50 €'dan başlar, güncel fiyat için WhatsApp'tan yazın.",
    en: "The Eco Green Tour is Cappadocia's southern nature-and-underground route: it starts at Göreme Panorama and Pigeon Valley, visits an onyx workshop, descends into the Kaymaklı and Derinkuyu underground cities, hikes through Ihlara Valley, pauses at Nar Lake and ends with a tasting of local flavours. A professional tour guide, transfer, lunch and museum entrance tickets are included; the tour runs 09:30-18:00. Prices start from €50 — message us on WhatsApp for the current price.",
  },
  "gun-batimi-turu": {
    tr: "Gün Batımı Panorama Turu, Kapadokya'nın en fotojenik saatini üç seyir noktasında yaşatır: Aktepe, Göreme Panorama ve Kızılçukur (Rose) Vadisi. Rehber ve transfer dahildir; günün son ışığı peribacalarını kızıla boyarken fotoğraf molası verirsiniz. Yaklaşık 3 saatlik bu tur balon uçuşunun akşam tamamlayıcısıdır. Fiyatlar 30 €'dan başlar, güncel fiyat için WhatsApp'tan yazın.",
    en: "The Sunset Panorama Tour takes you to Cappadocia's most photogenic hour at three viewpoints: Aktepe, Göreme Panorama and Kızılçukur (Rose) Valley. Guide and transfer are included; you pause for photos as the last light turns the fairy chimneys red. This roughly 3-hour tour is the evening counterpart to a balloon flight. Prices start from €30 — message us on WhatsApp for the current price.",
  },
  "instagram-turu": {
